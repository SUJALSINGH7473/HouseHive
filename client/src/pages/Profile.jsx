  ...
  return (
    <div className='p-3 max-w-lg mx-auto h-auto'>
      ...
      <input
        ...
        <Link className='bg-green-700 text-white p-3 text-center rounded-lg uppercase hover:opacity-95' to={"/create-listing"}>
            Create Listing
        </Link>
        </form>
      ...
      <p className="text-green-700 pt-3 text-sm text-center">{updateSuccess? "Updated Successfully":""}</p>
    </div>
  );
}
